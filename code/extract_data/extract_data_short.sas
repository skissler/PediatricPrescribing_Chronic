...
proc export data=cohort
	outfile='/home/kissler/PediatricPrescribing_Chronic/output/memb_df_prereduce_SAS.csv'
	dbms=csv
	replace;
run;
...
proc export data=cohort
	outfile='/home/kissler/PediatricPrescribing_Chronic/output/memb_df_SAS.csv'
	dbms=csv
	replace;
run;
